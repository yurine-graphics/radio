...
var colors = ['4A90E2', 'C374DE', 'F36342', 'F3A642', '93C93F'];
  ...
  Radio.prototype.renderBg = function(context, min, radio, lineWidth) {
    context.beginPath();
  ...
  Radio.prototype.renderFg = function(context, min, radio, lineWidth) {
    var self = this;
    var sum = 0;
  ...
  Radio.prototype.renderItem = function(item, i, context, min, radio, lineWidth, count, sum) {
